  ...
  public class Floor : MonoBehaviour
  {
    ...
    public void Create()
    {
      ...
      foreach (Vector2 point in building.points)
      {
        ...
        if (building.lowPoint == null || height <= building.lowPoint)
        {
          building.lowPoint = height;
        }

        if (building.hightPoint == null || height >= building.hightPoint)
        {
          building.hightPoint = height;
        }
      }
