...
namespace FunkySheep.Earth.Terrain
{
    ...
    class ObjExporter : EditorWindow
    {
        ...
        {
            terrain = null;
            UnityEngine.Terrain terrainObject = Selection.activeObject as UnityEngine.Terrain;
            if (!terrainObject)
            {
                terrainObject = UnityEngine.Terrain.activeTerrain;
            }
            if (terrainObject)
            {
            ...
            EditorWindow.GetWindow<ObjExporter>().Show();
        }
        ...
        void OnGUI()
        {
            if (!terrain)
            {
                ...
                {
                    EditorWindow.GetWindow<ObjExporter>().Close();
                }
                return;
            }
